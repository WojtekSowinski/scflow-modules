...
output:
  html_document:
    ...
    fig_caption: true
    keep_md: false
    css: !expr system.file("rmarkdown/css/style.css", package = "scflowdirichlet")
    includes:
      in_header: header.html
      after_body: !expr system.file("rmarkdown/html/footer.html", package = "scflowdirichlet")
params:
  results_path: false
---
...
<br>scFlow v`r utils::packageVersion("scflowdirichlet")` -- `r Sys.time()`
